...
import { GraduationCap, Mail, ArrowRight, AlertCircle, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl border border-slate-200 shadow-md relative">
        ...
        <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight mb-1">Student Portal Login</h2>
        <p className="text-xs text-slate-500 mb-6">Sign in to take timed assessments and track your scores.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1.5">Student Email</label>
        ...
        <div className="mt-6 text-center text-xs text-slate-500">
          New Student?{' '}
          <Link
            to={redirectPath ? `/register-student?redirect=${encodeURIComponent(redirectPath)}` : '/register-student'}
